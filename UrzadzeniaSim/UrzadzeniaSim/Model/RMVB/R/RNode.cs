...
namespace UrzadzeniaSim.Model.RMVB.R
{
    ...
    abstract public class RNode
    {
        ...
        public abstract void Insert(Urzadzenie_Model dev, TreeWalker adaptor);
        ...
        abstract public List<Urzadzenie_Model> SearchBy(Rectangle rect);

        abstract public Urzadzenie_Model SearchBy(Decimal x, Decimal y);
    }
}
