...
namespace UrzadzeniaSImScottplot.kontrolki
{
    /// <summary>
    /// Logika interakcji dla klasy wybor_prostokata.xaml
    /// </summary>
    public partial class wybor_prostokata : UserControl, INotifyPropertyChanged
    {
